//This script resize the camera at the begining of the game so that no matter what the
//resolution of the display is, everything important in the game can be seen.
